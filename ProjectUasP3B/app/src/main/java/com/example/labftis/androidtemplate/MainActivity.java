...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, ListenerGamePage{
    protected LinearLayout layout,fragContainer;
    protected Paint paint, paintText;
    protected int mColorBackground, mColorBackground2,white;
    protected int highScore=0;
    protected Engine e;
    protected Button btnPlay,btnExit;

    protected FragmentManager fm;
    protected FragmentTransaction ft;
    protected FragmentGamePage fgp;
    protected ScoreManager sm;

    protected ImageView ivCanvas, ivTarget;
    protected Bitmap mBitmap, targetBitmap;
    protected Canvas mCanvas, targetCanvas;

    protected BolaManager bm;
    protected SensorReader sr;
